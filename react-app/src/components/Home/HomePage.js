            ...
            <div className="dashboardContainer">
              <div className="row">
                <div className="mainContainer">
                  ...
                  {/* <div className="dashboardNews">News Test</div> */}
                </div>
      ...
      <div className="HomePageContainer3">
        ...
        <div className="HomePage3Item2">
          ...
          <div>
            ...
            <p className="h1p1">
              Request shares in new companies before their stock starts trading
              on public exchanges.
            </p>
          </div>
          <div>
            ...
            <p className="h1p1">
              ...
              opportunity to invest, regardless of order size or account value.
            </p>
          </div>
          <span className="IPO">
            {" "}
        ...
        <div className="hp41">
          ...
          <div className="hp412">
            ...
            <div className="hp41two">
              ...
              <span className="hp414Span">
                Customize your portfolio with pieces of different companies and
            ...
            <div className="hp41three">
              ...
              <span className="hp414Span">
                Trades placed during market hours are executed at that time, so
